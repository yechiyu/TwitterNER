...
clean_tweet_dir = './data/cleaned_tweets/'  # end with '/'
subwindow_dir = './data/cleaned_tweets/2021-03-25/'  # each file is a subwindow in this folder
event_output_dir = './results/2021-03-25/'
